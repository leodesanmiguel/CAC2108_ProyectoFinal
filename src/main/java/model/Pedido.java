...
public class Pedido {
	...
	// Pedido para mostrar los pedidos de un usuario
	public Pedido(Integer idPedido, String nombre, String apellido, String mail, 
			String lugarEntrega, Integer localidad, Integer provincia, String codPostal, 
			String formaDePago, String tarjTitular, String tarjNumero) {
		
		/* 
		 * idPedido, nombre, apellido, mail lugarentrega, localidad, provincia, codpostal,  formadepago, tarjtitular, tarjnumero   
		 * */
    ...
    // Pedido sin nro de pedido para el pendiente
	public Pedido(String nombre, String apellido, String usuario, String mail, String lugarEntrega,
			...
			String tarjNumero, String tarjVto, Integer tarjClave) {
		super();
		this.nombre = nombre;
		this.apellido = apellido;
